...
},{"./formats":36,"./utils":40}],40:[function(require,module,exports){
'use strict';
...
},{"./raf.js":70}],42:[function(require,module,exports){
"use strict";
...
},{"./hasClass.js":62}],43:[function(require,module,exports){
"use strict";
...
},{"./passiveOption.js":68}],44:[function(require,module,exports){
"use strict";
...
},{"./getBody.js":55,"./resetFakeBody.js":75,"./setFakeBody.js":77}],47:[function(require,module,exports){
"use strict";
...
},{"./getBody.js":55,"./resetFakeBody.js":75,"./setFakeBody.js":77}],61:[function(require,module,exports){
"use strict";
...
},{"./classListSupport.js":48}],63:[function(require,module,exports){
"use strict";
...
},{"./getBody.js":55,"./resetFakeBody.js":75,"./setFakeBody.js":77}],68:[function(require,module,exports){
"use strict";
...
},{"./getBody.js":55,"./resetFakeBody.js":75,"./setFakeBody.js":77}],70:[function(require,module,exports){
"use strict";
...
},{"./isNodeList.js":64}],72:[function(require,module,exports){
"use strict";
...
},{"./raf.js":70}],73:[function(require,module,exports){
"use strict";
...
},{"./hasClass.js":62}],74:[function(require,module,exports){
"use strict";
...
},{"./passiveOption.js":68}],75:[function(require,module,exports){
"use strict";
...
},{"./docElement.js":50}],76:[function(require,module,exports){
"use strict";
...
},{"./isNodeList.js":64}],77:[function(require,module,exports){
"use strict";
...
},{"./docElement.js":50}],78:[function(require,module,exports){
"use strict";
...
},{"./helpers/addCSSRule.js":41,"./helpers/addClass.js":42,"./helpers/addEvents.js":43,"./helpers/arrayFromNodeList.js":44,"./helpers/caf.js":45,"./helpers/calc.js":46,"./helpers/checkStorageValue.js":47,"./helpers/createStyleSheet.js":49,"./helpers/events.js":51,"./helpers/extend.js":52,"./helpers/forEach.js":53,"./helpers/getAttr.js":54,"./helpers/getCssRulesLength.js":56,"./helpers/getEndProperty.js":57,"./helpers/getSlideId.js":58,"./helpers/getTouchDirection.js":59,"./helpers/has3DTransforms.js":60,"./helpers/hasAttr.js":61,"./helpers/hasClass.js":62,"./helpers/hideElement.js":63,"./helpers/isVisible.js":65,"./helpers/jsTransform.js":66,"./helpers/mediaquerySupport.js":67,"./helpers/percentageLayout.js":69,"./helpers/raf.js":70,"./helpers/removeAttrs.js":71,"./helpers/removeCSSRule.js":72,"./helpers/removeClass.js":73,"./helpers/removeEvents.js":74,"./helpers/setAttrs.js":76,"./helpers/setLocalStorage.js":78,"./helpers/showElement.js":79,"./helpers/toDegree.js":80,"./helpers/whichProperty.js":81}],83:[function(require,module,exports){
"use strict";
...
function initContactForm() {
  ...
  if (phone) {
    ...
    var mask = new _imask.default(phone, maskOptions);
  }
  ...
  var validate = new _bouncer.default('.js-contato', {
    disableSubmit: true,
...
},{"../config":83,"@babel/runtime/helpers/interopRequireDefault":2,"axios":6,"bouncer":31,"imask":32,"qs":37}],85:[function(require,module,exports){
"use strict";
...
function handleSliderTimer() {
  return _handleSliderTimer.apply(this, arguments);
}

function _handleSliderTimer() {
  _handleSliderTimer = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
...
},{"../config":83,"@babel/runtime/helpers/interopRequireDefault":2,"axios":6,"bouncer":31,"qs":37}],90:[function(require,module,exports){
"use strict";
...
function shufleAndSelect(array, items) {
  ...
  var selected = shuffled.slice(0, items);
  return selected;
}
...
function _initRamdomize() {
  _initRamdomize = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
  _regenerator.default.mark(function _callee() {
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _axios.default.get('/inspirese/index.json').then(function (response) {
              return response.data.inspirese;
          ...
          case 2:
            _context.next = 4;
            return _axios.default.get('/novidades/index.json').then(function (response) {
              return response.data.novidades;
            }).then(function (response) {
              return shufleAndSelect(response, 3);
            }).then(function (response) {
          ...
          case 4:
            _context.next = 6;
            return _axios.default.get('/depoimentos/index.json').then(function (response) {
          ...
          case 6:
            _context.next = 8;
            return _axios.default.get('/pesquisas/index.json').then(function (response) {
              return response.data.pesquisas;
            }).then(function (response) {
...
function initTabs() {
  var $tabLinks = document.querySelectorAll('.tabs__controller a');
  var $tabs = document.querySelectorAll('.tabs__content div');
