...
O distanciamento social provou ser uma das medidas mais efetivas para prevenir o contágio do COVID-19. No contexto escolar, isso significa reduzir o contato entre grupos de crianças e manter uma distância segura de 1-2 metros. Para isso, deve-se levar em consideração fatores como o tamanho da sala de aula, a disponibilidades de salas e o número de alunos por cada sala. Para garantir os benefícios do ensino presencial dentro desse contexto 60% dos países membros da OCDE e parceiros estão organizando diferentes turnos durante o dia para acomodar os alunos. Contudo, para garantir o tempo necessário de instrução neste modelo, é necessário estabelecer formas efetivas de aprendizagem híbrida combinando experiências online e presenciais. 
